...
C<climate?> - A standalone root affix

C<climate?(?:ize)?> - A root with a suffix

C<a?climate?(?:ize)?> - A root with both prefix and suffix

C<a(?=\w)> - A prefix ("must precede")

C<(?<=\w)ize> - A suffix ("must follow")
